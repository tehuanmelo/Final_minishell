...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/16 14:10:08 by mbin-nas          #+#    #+#             */
/*   Updated: 2023/05/16 14:20:33 by mbin-nas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# @brief: 
* A new env variable will be stored by duplciating the env variable to the 
* new_env
# @return: 
* A new_env_var_stored to be used 
* ----> To be used in the setting_the_envr when appending the new path 
* or creating it  
*/
